...
def authGoogle(request):
    ...
    redirection = "https://machinaappication.page.link/?link=https://machinaappication.page.link{}/{user_id}?emailOrPhone={}&apn=com.autoapp.application&amv=0&afl=google.com".format(
